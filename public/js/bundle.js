...
const displayMap = locations => {
  mapboxgl.accessToken = 'pk.eyJ1IjoiemlhZGFtYWxsIiwiYSI6ImNtaWQ5MWNhejAyZ3gybHNrc2xjNTg4encifQ._dThtOtRGo5NBgCuC1qifQ';
...
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
const stripe = Stripe("pk_test_51SWVIbK55reZt4bMk3k5qoRJnPwFu4uQTax4fsABXNuFeGgTKIW5MoWBDVbDtBPV0FTjEKoubtU1rWrcBF4GgoM200vMHEQ590");
...
if (signupForm) {
  signupForm.addEventListener("submit", e => {
    ...
    form.append("passwordConfirm", document.getElementById("password-confirm").value);
    if (photoInput) {
